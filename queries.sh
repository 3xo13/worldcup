...
#"$($PSQL "select t1.name as team1, t2.name as team2 from games g inner join teams t1 on t1.team_id = g.winner_id inner join teams t2 on t2.team_id = g.opponent_id WHERE round='Eighth-Final' AND year=2014 ; ")"
